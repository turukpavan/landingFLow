            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div>
                ...
                <div className="text-right mt-1.5">
                  <button type="button" className="text-[11px] text-[#885EFF]">
                    Forgot Password?
                  </button>
                </div>
              </div>
              ...
              <p className="text-center text-[11px] text-gray-500 pt-1">
                ...
                <button onClick={() => navigate("/auth/signup")} className="text-[#885EFF] font-medium cursor-pointer hover:underline">
                  Sign Up
                </button>
              </p>
            </form>
