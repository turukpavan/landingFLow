...
export const ButtonArrowIcon = ({ className = "w-2.5 h-2.5 sm:w-3 sm:h-3" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const TrendingUpIcon = ({ className = "w-3.5 h-3.5 text-blue-500" }) => (
  ...
  >
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28l-2.28 5.941"
    />
  </svg>
);

export const SelectChevronIcon = ({ className = "w-3 h-3" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const SelectDoubleChevronIcon = ({ className = "w-2.5 h-2.5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const SearchIcon = ({ className = "w-4 h-4 text-gray-400 mr-2 flex-shrink-0" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const ArrowDownLongIcon = ({ className = "w-2.5 h-2.5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const ScrollChevronIcon = ({ className = "w-3 h-3" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const StarIcon = ({ className = "w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-amber-400" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    viewBox="0 0 24 24"
    fill="currentColor"
...
export const OfficeBuildingIcon = ({ className = "w-4 h-4 sm:w-5 sm:h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const HomeIcon = ({ className = "w-4 h-4 sm:w-5 sm:h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const CalendarIcon = ({ className = "w-4 h-4 sm:w-5 sm:h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const ArrowRightIcon = ({ className = "w-3.5 h-3.5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const ChevronLeftIcon = ({ className = "w-3 h-3" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const LocationIcon = ({ className = "w-3.5 h-3.5 flex-shrink-0" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const HappyFaceIcon = ({ className = "w-5 h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const PaperPlaneIcon = ({ className = "w-5 h-5" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const MailIcon = ({ className = "w-5 h-5 shrink-0 text-purple-300" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const InstagramIcon = ({ className = "w-5 h-5 fill-current" }) => (
  <svg className={className} viewBox="0 0 24 24">
...
export const TwitterIcon = ({ className = "w-5 h-5 fill-current" }) => (
  <svg className={className} viewBox="0 0 24 24">
...
export const OutlinedMailIcon = ({ className = "w-4 h-4" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
...
export const EyeClosedIcon = ({ className = "w-4 h-4" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
